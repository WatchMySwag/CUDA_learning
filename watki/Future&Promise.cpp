...
int main() { 
 ...
 cout<<"Podaj haslo: ";
    ...
    thread sprawdzacz(sprawdzaczHasla,move(obietnica), haslo); // tworze watek, ktory sprawdzi haslo, przekazując mu promise. Używamy move, bo promise nie jest kopiowalny, a tylko przenoszalny. 
